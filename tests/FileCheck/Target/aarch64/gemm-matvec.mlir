...
// LOWERED-DAG: llvm.func @annc_aarch64_neon_matvec_mr4_k8_f32
// LOWERED-DAG: llvm.func @annc_aarch64_neon_matvec_mr2_k8_acc_f32
// LOWERED: llvm.call @annc_aarch64_neon_matvec_mr4_k8_f32
// LOWERED: llvm.call @annc_aarch64_neon_matvec_mr2_k8_acc_f32
// LOWERED-NOT: linalg.matmul

func.func @matvec(%c: memref<34x1xf32>, %a: memref<34x800xf32>,
                   %b: memref<800x1xf32>) {
