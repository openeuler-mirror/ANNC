...
#if don't use Fortran, it will only compile KP.
if (ONLY_KP)
  set(NO_LAPACK 1)
else ()
  set(ONLY_KP 0)
...
if (GEMM_GEMV_FORWARD AND NOT ONLY_KP)
  set(CCOMMON_OPT "${CCOMMON_OPT} -DGEMM_GEMV_FORWARD")
endif ()
if (GEMM_GEMV_FORWARD_BF16 AND NOT ONLY_KP)
...
if (NOT NO_KP)
  set(LIB_COMPONENTS "${LIB_COMPONENTS} KP")
endif ()
