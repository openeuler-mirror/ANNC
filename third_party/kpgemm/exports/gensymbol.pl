...
# added Kp_cgemm3m and Kp_zgemm3m
...
@kpobjsc = (
    kp_caxpy, kp_ccopy, kp_cdotc, kp_cdotu, kp_cgbmv, kp_cgemm, kp_cgemv,
    kp_cgerc, kp_cgeru, kp_chbmv, kp_chemm, kp_chemv, kp_cher2, kp_cher2k,
    kp_cher, kp_cherk,  kp_chpmv, kp_chpr2, kp_chpr, kp_cscal, kp_caxpby,
    kp_csscal, kp_cswap, kp_csymm, kp_csyr2k, kp_csyrk, kp_ctbmv, kp_cgeadd,
    kp_ctbsv, kp_ctpmv, kp_ctpsv, kp_ctrmm, kp_ctrmv, kp_ctrsm, kp_ctrsv, 
    kp_scnrm2, kp_scasum, kp_cgemmt, kp_cgemmtr,
    kp_icamax, kp_icamin, kp_icmin, kp_icmax, kp_scsum,kp_cimatcopy,kp_comatcopy,
    kp_caxpyc, kp_crotg, kp_csrot, kp_scamax, kp_scamin, kp_cgemm_batch);

@kpobjsd = (
    kp_dasum, kp_daxpy, kp_dcopy, kp_ddot,
    kp_dgbmv, kp_dgemm, kp_dgemv, kp_dger, kp_dnrm2,
    kp_drot, kp_drotg, kp_drotm, kp_drotmg, kp_dsbmv, kp_dscal, kp_dsdot,
    kp_dspmv, kp_dspr2, kp_dspr, kp_dswap, kp_dsymm, kp_dsymv, kp_dsyr2,
    kp_dsyr2k, kp_dsyr, kp_dsyrk, kp_dtbmv, kp_dtbsv, kp_dtpmv, kp_dtpsv,
    kp_dtrmm, kp_dtrmv, kp_dtrsm, kp_dtrsv, kp_daxpby, kp_dgeadd, kp_dgemmt, kp_dgemmtr,
    kp_idamax, kp_idamin, kp_idmin, kp_idmax, kp_dsum,kp_dimatcopy,kp_domatcopy,
    kp_damax, kp_damin, kp_dgemm_batch);
    
@kpobjss = (
    kp_sasum, kp_saxpy, kp_saxpby,
    kp_scopy, kp_sdot, kp_sdsdot, kp_sgbmv, kp_sgemm,
    kp_sgemv, kp_sger, kp_snrm2, kp_srot, kp_srotg,
    kp_srotm, kp_srotmg, kp_ssbmv, kp_sscal, kp_sspmv, kp_sspr2, kp_sspr,
    kp_sswap, kp_ssymm, kp_ssymv, kp_ssyr2, kp_ssyr2k, kp_ssyr, kp_ssyrk,
    kp_stbmv, kp_stbsv, kp_stpmv, kp_stpsv, kp_strmm, kp_strmv, kp_strsm,
    kp_strsv, kp_sgeadd, kp_sgemmt, kp_sgemmtr,
    kp_isamax, kp_isamin, kp_ismin, kp_ismax, kp_ssum,kp_simatcopy,kp_somatcopy,
    kp_samax, kp_samin, kp_sgemm_batch);

@kpobjsz = (
    kp_dzasum, kp_dznrm2, kp_zaxpy, kp_zcopy, kp_zdotc, kp_zdotu, kp_zdscal,
    kp_zgbmv, kp_zgemm, kp_zgemv, kp_zgerc, kp_zgeru, kp_zhbmv, kp_zhemm,
    kp_zhemv, kp_zher2, kp_zher2k, kp_zher, kp_zherk, kp_zhpmv, kp_zhpr2,
    kp_zhpr, kp_zscal, kp_zswap, kp_zsymm, kp_zsyr2k, kp_zsyrk,
    kp_ztbmv, kp_ztbsv, kp_ztpmv, kp_ztpsv, kp_ztrmm, kp_ztrmv, kp_ztrsm,
    kp_ztrsv, kp_cdotc_sub, kp_cdotu_sub, kp_zdotc_sub, kp_zdotu_sub,
    kp_zaxpby, kp_zgeadd, kp_zgemmt, kp_zgemmtr,
    kp_izamax, kp_izamin, kp_izmin, kp_izmax, kp_dzsum,kp_zimatcopy,kp_zomatcopy,
    kp_zaxpyc, kp_zdrot, kp_zrotg, kp_dzamax, kp_dzamin, kp_zgemm_batch);

@kpobjs = (  kp_xerbla );

@bfkpobjs = (kp_sbgemm, kp_sbgemmt, kp_sbgemmtr, kp_sbgemv, kp_sbdot, kp_sbstobf16, kp_sbdtobf16, kp_sbf16tos, kp_dbf16tod, kp_sbgemm_batch);
...
if ($ARGV[12] == 1) {
	...
	@kpobjs = (@kpobjs, @bfkpobjs);
}
if ($ARGV[13] == 1) {
	@blasobjs = (@blasobjs, @blasobjss);
	@kpobjs = (@kpobjs, @kpobjss);
...
if ($ARGV[15] == 1) {
	...
	@kpobjs = (@kpobjs, @kpobjsc);
	@gemm3mobjs = (@gemm3mobjs, @gemm3mobjsc);
	@kpgemm3mobjs = (@kpgemm3mobjs, @kpgemm3mobjsc);
...
if ($ARGV[16] == 1) {
	...
	@kpobjs = (@kpobjs, @kpobjsz);
	@gemm3mobjs = (@gemm3mobjs, @gemm3mobjsz);
	@kpgemm3mobjs = (@kpgemm3mobjs, @kpgemm3mobjsz);
...
if ($ARGV[4] == 0) {
    @no_underscore_objs = (@kpobjs, @misc_no_underscore_objs);
    if ($ARGV[1] eq "x86_64") { @no_underscore_objs = (@no_underscore_objs, @kpgemm3mobjs); };
    if ($ARGV[1] eq "x86")    { @no_underscore_objs = (@no_underscore_objs, @kpgemm3mobjs); };
    if ($ARGV[1] eq "ia64")   { @no_underscore_objs = (@no_underscore_objs, @kpgemm3mobjs); };
    if ($ARGV[1] eq "MIPS")   { @no_underscore_objs = (@no_underscore_objs, @kpgemm3mobjs); };
}else{
    #NO_KP=1
