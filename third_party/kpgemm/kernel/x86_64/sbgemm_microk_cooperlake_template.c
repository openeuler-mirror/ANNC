...
/*
#ifndef ONE_ALPHA      // ALPHA is not ONE
void sbgemm_internal_kernel_alpha(OPENBLAS_CONST enum KP_ORDER Order, OPENBLAS_CONST enum KP_TRANSPOSE TransA, OPENBLAS_CONST enum KP_TRANSPOSE TransB, OPENBLAS_CONST blasint M, OPENBLAS_CONST blasint N, OPENBLAS_CONST blasint K,
...
#else                  // ALPHA is ONE
void sbgemm_internal_kernel_one(OPENBLAS_CONST enum KP_ORDER Order, OPENBLAS_CONST enum KP_TRANSPOSE TransA, OPENBLAS_CONST enum KP_TRANSPOSE TransB, OPENBLAS_CONST blasint M, OPENBLAS_CONST blasint N, OPENBLAS_CONST blasint K,
		 OPENBLAS_CONST float alpha, OPENBLAS_CONST bfloat16 *A, OPENBLAS_CONST blasint lda, OPENBLAS_CONST bfloat16 *B, OPENBLAS_CONST blasint ldb, float *C, OPENBLAS_CONST blasint ldc)
#endif
{
    if (Order == KpColMajor) {
